...
namespace LOGHouseSystem.Migrations
{
    ...
    [Migration("20240229133505_InventoryMovimentsNewDates")]
    partial class InventoryMovimentsNewDates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.RetryQueue", b =>
                {
                    b.HasOne("LOGHouseSystem.Models.HookInput", "HookInput")
                        .WithMany()
                        .HasForeignKey("HookInputId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HookInput");
                });
