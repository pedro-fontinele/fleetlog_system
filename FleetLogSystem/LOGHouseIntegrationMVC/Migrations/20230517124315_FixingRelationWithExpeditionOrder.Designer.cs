...
namespace LOGHouseSystem.Migrations
{
    ...
    [Migration("20230517124315_FixingRelationWithExpeditionOrder")]
    partial class FixingRelationWithExpeditionOrder
    {
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.ExpeditionOrder", b =>
                {
                    ...
                    b.Property<int>("ShippingDetailsId1")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ShippingDetailsId1");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.ExpeditionOrder", b =>
                {
                    b.HasOne("LOGHouseSystem.Models.ShippingDetails", "ShippingDetails")
                        .WithMany()
                        .HasForeignKey("ShippingDetailsId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
