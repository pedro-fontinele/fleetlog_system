...
namespace LOGHouseSystem.Migrations
{
    ...
    [Migration("20240313004317_ReceiptNoteProductsInvoiceMTable")]
    partial class ReceiptNoteProductsInvoiceMTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.AppVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.ClientContract", b =>
                {
                    ...
                    b.Property<decimal?>("ExcessOrderValue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.Devolution", b =>
                {
                    ...
                    b.Property<int?>("ReceiptScheduleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.ExpeditionOrder", b =>
                {
                    ...
                    b.Property<int>("ReturnedInvoiceGenerated")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ShippingTagBlocked")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.ExpeditionOrdersLotNotFounded", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ExpeditionOrdersLotNotFounded");
                });
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.HangfireExecutionControl", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HangfireExecutionControls");
                });
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.InventoryMovement", b =>
                {
                    ...
                    b.Property<double>("QuantityFinalQuantity")
                        .HasColumnType("float");

                    b.Property<int>("StockSlotMoviment")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.InvoiceItem", b =>
                {
                    ...
                    b.Property<string>("PositionAddress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.PackingListTransportationHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PackingListTransportationHistories");
                });
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.ReceiptScheduling", b =>
                {
                    ...
                    b.Property<decimal?>("VolumesQuantity")
                        .IsRequired()
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.ReturnInvoiceOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReturnInvoiceOrders");
                });

            modelBuilder.Entity("LOGHouseSystem.Models.ReturnInvoiceProductInvoices", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReturnInvoiceProductInvoices");
                });
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.SmartgoImportation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.Packing", b =>
                {
                    ...
                    b.HasOne("LOGHouseSystem.Models.PackingListTransportation", "PackingListTransportation")
                        .WithMany()
                        .HasForeignKey("PackingListTransportationId");
                    ...
                    b.Navigation("PackingListTransportation");
                });

            modelBuilder.Entity("LOGHouseSystem.Models.PackingHistory", b =>
                {
                    b.HasOne("LOGHouseSystem.Models.Packing", "Packing")
                        .WithMany("PackingHistories")
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.PackingListTransportationHistory", b =>
                {
                    b.HasOne("LOGHouseSystem.Models.PackingListTransportation", "PackingListTransportation")
                        .WithMany("PackingListTransportationHistories")
                        .HasForeignKey("PackingListTransportationId");
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.ReturnInvoiceOrders", b =>
                {
                    ...
                    b.HasOne("LOGHouseSystem.Models.ReturnInvoice", "ReturnInvoice")
                        .WithMany()
                        .HasForeignKey("ReturnInvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.PackingListTransportation", b =>
                {
                    ...
                    b.Navigation("PackingListTransportationHistories");
                });
            ...
            modelBuilder.Entity("LOGHouseSystem.Models.PickingList", b =>
                {
                    ...
                    b.Navigation("PickingListHistories");
